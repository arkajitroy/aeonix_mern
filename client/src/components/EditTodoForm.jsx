  ...
  return (
    <div className="bg-violet-50 w-[90%] md:w-[80%] lg:w-[50%] p-5 rounded-sm shadow-md">
      ...
      <form
        ...
        <input type="text" className="my-4 w-full border-0 border-gray-500 px-5 py-2 rounded-sm my-2" placeholder="Add here todo title" value={todoTitle} onChange={(e) => setTodoTitle(e.target.value)} />

        {/* TODOS DESCRIPTION INPUT FIELD */}
        <textarea className="my-4 w-full border-0 border-gray-500 px-5 py-2 rounded-sm" cols="30" rows="3" placeholder="Add here todo description" value={todoDescription} onChange={(e) => setTodoDescription(e.target.value)} />


        {/* TODOS UPDATE & BACK HOMEPAGE BUTTON */}
        <div className="w-full flex flex-row items-center justify-center">
          <button type="submit" className="bg-teal-600 text-white rounded-sm shadow-md w-full my-2 py-2 mr-2 transition-all duration-100 hover:bg-teal-800">
            Update Todo
          </button>
